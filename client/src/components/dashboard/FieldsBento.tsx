...
function FieldsBento(props: {
  ...
  return (
    <div className="flex flex-wrap gap-4 mt-8 mb-24">
          ...
          return (
            <div key={index} className={`${fieldCardClass} p-8 flex flex-col`}>
              <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <svg
                      className={`scale-125 -translate-y-[2px] ${
                        props.fieldsData.update[key] == 1
                          ? "text-green-500"
                          : "text-red rotate-180"
                      } ${props.fieldsData.update[key] == 0 ? "hidden" : ""}`}
                    ...
                    >
                      <path
                        d="M5 0.5L9.33013 8H0.669873L5 0.5Z"
                        fill="currentColor"
                      />
                    </svg>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`bg-background2 rounded-xl p-2 md:p-4 flex gap-2 items-center`}
                  >
                    <svg
                      className="scale-125"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <svg
                    className="text-text/50 transition-all cursor-pointer hover:text-red hover:scale-105 active:scale-95"
                    onClick={() => {
              ...
              <Heatmap
                className="mt-6"
                numberOfMonths={13}
                heatMapData={{ [key]: props?.fieldsData?.history[key] }}
              />
            </div>
          );
        })}
      <div
        onClick={() => {
          props.AddFieldFunction();
        }}
        className={`${fieldCardClass} grid place-items-center group cursor-pointer`}
      >
